...
export default function SkillsDownload() {
  ...
  return (
    <div className="my-6">
      <div className="max-w-lg mx-auto p-7 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:border-emerald-500 dark:hover:border-emerald-500 hover:shadow-md transition-all duration-200">
        ...
        <a
          href={downloadUrl}
          className="inline-flex items-center justify-center gap-1.5 w-full px-6 py-3 bg-emerald-600 text-white text-sm rounded-lg hover:bg-emerald-700 transition-colors font-medium shadow-sm hover:shadow text-center"
          download
        >
